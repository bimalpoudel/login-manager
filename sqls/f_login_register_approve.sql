...
*/
DROP FUNCTION IF EXISTS f_login_register_approve;
DELIMITER $$
CREATE FUNCTION f_login_register_approve(_login_id INTEGER(10) UNSIGNED, _login_code VARCHAR(255))
RETURNS BOOLEAN
BEGIN
	/**
	...
	*/
	...
	RETURN TRUE;
END $$
SELECT f_login_register_approve(1, '222') approved;